...
export function SettingsView() {
    ...
    const [translation, setTranslation] = useState({ enabled: false, targetLanguage: 'Spanish' });
    const [weeklyWordLimit, setWeeklyWordLimit] = useState(500);
            ...
            if (api) {
                try {
                    ...
                    if (settings) {
                        ...
                        setWeeklyWordLimit(settings.weeklyWordLimit || 500);
    ...
    const save = async (updates: Partial<{ translation: typeof translation; weeklyWordLimit: number; microphoneId: string }>) => {
        try {
            ...
            if (api) {
                ...
                const newSettings = {
                    translation: updates.translation ?? translation,
                    microphoneId: updates.microphoneId ?? selectedMic,
                    weeklyWordLimit: updates.weeklyWordLimit ?? weeklyWordLimit
                };
                ...
                if (updates.weeklyWordLimit !== undefined) setWeeklyWordLimit(updates.weeklyWordLimit);
                    ...
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <label className="relative inline-flex items-center cursor-pointer">
                            <input
                                ...
                                onChange={(e) => save({ translation: { ...translation, enabled: e.target.checked } })}
                    ...
                    {translation.enabled && (
                        <div className="animate-in fade-in slide-in-from-top-2 duration-200">
                            ...
                            <select
                                ...
                                onChange={(e) => save({ translation: { ...translation, targetLanguage: e.target.value } })}
                                className="w-full bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5"
                            >
                            ...
                            <p className="mt-2 text-xs text-gray-500">
                                Spoken text (English) will be translated to {translation.targetLanguage} before pasting.
                            </p>
                        </div>
                    )}
                </section>
