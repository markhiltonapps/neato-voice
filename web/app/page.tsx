...
const Navbar = () => {
  ...
  const handleDownload = (e: React.MouseEvent) => {
    e.preventDefault();
    // Scroll to pricing section - users must select a plan before downloading
          ...
          >
            <div className="px-6 py-8 space-y-6">
              ...
              <div className="pt-6 border-t border-surface-2 grid grid-cols-2 gap-4">
                ...
                <Link href="#pricing" className="flex items-center justify-center py-3 rounded-lg bg-accent-blue text-white font-bold">Download</Link>
              </div>
            </div>
          </motion.div>
        )}
